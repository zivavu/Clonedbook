...
export const getCustomShadows = (mode: 'light' | 'dark') => {
  ...
  if (mode === 'light') {
    ...
    shadows[15] = `${getShadowBaseColor(mode, 0.2)} 0px 2px 12px 0px`;
    shadows[19] = `${getShadowBaseColor(mode, 0.2)} 0px 12px 28px 0px,
      ${getShadowBaseColor(mode, 0.1)} 0px 2px 4px 0px`;
    shadows[20] = `${getShadowBaseColor(mode, 0.2)} 0px 12px 28px 0px,
      ${getShadowBaseColor(mode, 0.1)} 0px 2px 4px 0px,
